...
pub fn add_code_view_ui<R>(
    ...
    let code_view = egui::TextEdit::multiline(code)
        .code_editor()
...
impl CodeTheme {
    ...
    pub fn dark() -> Self {
        Self {
            dark_mode: true,
            syntect_theme: SyntectTheme::Dracula,
        }
    }
...
impl Default for Highlighter {
    fn default() -> Self {
        ...
        let dracula = syntect::highlighting::ThemeSet::load_from_reader(
            &mut std::io::BufReader::new(std::io::Cursor::new(DRACULA_THEME)),
        )
        .expect("Failed to load Dracula theme");

        ts.themes.insert("Dracula".into(), dracula);
